             ...
             <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Global Parameters</h1>
...
$resultquery = mysqli_query($link, $query) or die(mysqli_error($link));
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addnewcoinlabel"></h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
				<input autocomplete="off" type='text' id='param_header' style='width:95%;margin:0 auto;' placeholder=''/><hr style='visibility:hidden;'>
				<input autocomplete="off" type='text' id='confirmparam' style='width:95%;margin:0 auto;' placeholder='New Param'/><hr style='visibility:hidden;'>
				<input autocomplete="off" type='text' id='confirmparam2' style='width:95%;margin:0 auto;' placeholder='Confirm New Param'/><hr style='visibility:hidden;'>
 <div class="col-md-6">
                ...
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <a class="btn btn-primary" onclick="return _confirmchange(document.getElementById('param_header').value,document.getElementById('confirmparam').value ,document.getElementById('confirmparam').value );">OK</a>
                </div>
            </div>
        </div>
    </div>
...
{
	globalmode='add';
	$("#param_header").prop("readonly", false);
	$('#param_header').val('');
	$('#confirmparam').val('');
...
function _testttttttttttttttt(paramname,paramvalue)
{
	 
	globalmode='edit';
  	$("#param_header").prop("readonly", true);
	 $.ajax({

     type: "GET",
     url: 'ajax/listener.php?actionmode=getparamdata&param_name='+paramname,
   ...
   $('#param_header').val(coinabr);
   $('#confirmparam').val(coinfullname);
...
function _modify(paramname)
{
   ...
   var res = data.split("{}");
	 ...
	 var coinfullname = res[1];
	 var coindigits = res[1];
   $('#param_header').val(coinabr);
   $('#confirmparam').val(coinfullname);
...
function _delete(coinid,confirmparam)
{
	coin_id = coinid;
...
function _confirmchange(abbr,name)
{
...
if(boolchk==true)
{
		  $.ajax({
  type: 'POST',
  url: 'ajax/listener.php?actionmode=modifyglobalparam&param_name='+abbr+'&param_value='+name,
  data: '',
	...
	function populateactivetrades()
{
	...
	theurl = '';
     ...
     type: "GET",
     url: 'ajax/getlistofglobalparams.php',
     data: theurl, // appears as $_GET['id'] @ your backend side
     success: function(data) {
           // data is ur summary
