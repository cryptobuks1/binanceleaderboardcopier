             ...
             <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Trades History</h1>
						<div class="btn-group">
  <button type="button" class="btn btn-primary" id='thedays' name='thedays' >Last 2 Days</button>
  <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    <span class="sr-only">Toggle Dropdown</span>
  </button>
  <div class="dropdown-menu" style='cursor:pointer;'>
      <a class="dropdown-item" onclick = "$('#thedays').html('Last 2 Days');populateactivetrades(2);">Last 2 Days</a>
    <a class="dropdown-item" onclick = "$('#thedays').html('Last 5 Days');populateactivetrades(5);">Last 5 Days</a>
	    <div class="dropdown-divider"></div>
    <a class="dropdown-item" onclick = "$('#thedays').html('Last Week');populateactivetrades(7);">Last Week</a>
    <a class="dropdown-item" onclick = "$('#thedays').html('Last 2 Weeks');populateactivetrades(14);">Last 2 Weeks</a>
	
	    <div class="dropdown-divider"></div>
    <a class="dropdown-item" onclick = "$('#thedays').html('Last Month');populateactivetrades(30);">Last Month</a>
  
    <a class="dropdown-item" onclick = "$('#thedays').html('Last 3 Months');populateactivetrades(90);">Last 3 Months</a>
	
	    <div class="dropdown-divider"></div>
		  <a class="dropdown-item" onclick = "$('#thedays').html('Last Year');populateactivetrades(360);">Last Year</a>
		    <a class="dropdown-item" onclick = "$('#thedays').html('Last 2 Years');populateactivetrades(720);">Last 2 Years</a>
			    <div class="dropdown-divider"></div>
			  <a class="dropdown-item" onclick = "$('#thedays').html('All Time');populateactivetrades(5000);">All Time</a>
  </div>
</div>
...
$(document).ready(function()
{
	...
	function populateactivetrades(_days)
{
	...
	theurl = '';
     ...
     type: "GET",
     url: 'ajax/getlistoftradeshistory.php?interval='+_days,
     data: theurl, // appears as $_GET['id'] @ your backend side
     success: function(data) {
           // data is ur summary
