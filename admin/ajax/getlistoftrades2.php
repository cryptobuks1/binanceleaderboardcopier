...
from tbl_trades where trade_closedat IS NULL order by trade_openedat desc ";										
 ...
 if(! $link ) {
   ...
   while($row = mysqli_fetch_assoc($result)) {
				...
				<td class='trd__date'><b class='b_date_'>$date_trade</b> <br> <p style='zoom:1.13;font-size:small;'><i>Order Id:<br><u class='trd__hash'>$trade_hash</u></i></p><input type='hidden' class='coin_leverage' value='$trade_leverage' /> <input type='hidden' class='trade_amount' value='$trade_amount' /><input type='hidden' class='coin_digits' value='$trade_coin_digits' /> </td>
