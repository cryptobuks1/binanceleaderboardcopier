			...
			if($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	{   mysqli_select_db($link, "binancefutures");
		$queryselectpass = "select client_pass  as checkcustomerpass from tbl_client where client_id= '".$_SESSION['customer']."'";
		...
		$resultpass = mysqli_query($link, $queryselectpass) or die(mysqli_error($link));
		  ...
		  if($checkcustomerpass == $oldpass)
		  {
			  $queryupdate = "update tbl_client set client_pass = ".GetSQLValueString($newpass,"text")." where client_id='".$_SESSION['customer']."'";
...
function getParameterByName(name, url) {
    ...
    <title>Profile and security</title>
<style type='text/css'>
             ...
             <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Profile and security</h1>
                    ...
                    <!-- Content Row -->
                     <div class="container-fluid">
						...
						<input type="password" id='newpassconf' name='newpassconf' class="form-control" placeholder="Confirm New Password">
					</div>
					<div class="form-group">
					<div id='errordiv' style='width:100%;text-align:center;color:coral;'>
					</div>
